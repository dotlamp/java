...
public class member_local_variable_call {
    ...
    public static void main(String[] args){
        ...
        member_variable.print1(); //인스턴스를 생성하지 않아도 호출 가능 // static void print1(){...}

        member_variable name = new member_variable(); //인스턴스 생성
        name.print2(); //호출 //  void print2(){...}
        ...
        System.out.println("클래스 변수 a : "+ member_variable.a); //1
        System.out.println("클래스 변수 ex1.a : "+ex1.a); //1
        System.out.println("클래스 변수 ex2.a : "+ex2.a); //1
        System.out.println("인스턴스 변수 ex1.b : "+ex1.b); //2
        System.out.println("인스턴스 변수 ex2.b : "+ex2.b); //2
        ...
        System.out.println("클래스 변수 ex1.a : "+ex1.a); //3 //100
        System.out.println("클래스 변수 ex2.a : "+ex2.a); //3 //100
        // 객체가 생성될 때마다 생성되는 각각의 변수가 아니라
        // 공유하는 변수이므로 ex1 객체에서 클래스 변수를 수정하고
        // ex2 객체에서 이 클래스 변수를 출력하면 수정한 값이 출력된다.
        System.out.println("인스턴스 변수 ex1.b : "+ex1.b); //4
        System.out.println("인스턴스 변수 ex2.b : "+ex2.b); //2
